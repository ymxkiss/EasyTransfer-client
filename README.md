...
<img src="https://github.com/WCY-dt/EasyTransfer/blob/main/assets/og-image.png" height="500" />
...
## DOCKER部署
```
docker run -d --restart=always --name=EasyTransfer-client -p 18880:80 ghcr.io/ymxkiss/easytransfer-client:latest
```
